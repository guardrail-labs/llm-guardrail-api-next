...
# Global instance for now; if needed later, this can be moved into app state.
license_state = LicenseState()


def initialize_license_from_env(
    ...
    # Placeholder for future real verification. For now we just record that a key exists.
    license_state.set(
        LicenseStatus(
            status=LicenseStatusCode.UNKNOWN,
            plan=None,
