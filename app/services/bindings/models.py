...
class Binding:
    ...
    def overlaps(self, other: "Binding") -> bool:
        ...
        tenants_overlap = (
            self.tenant_id == other.tenant_id or self.tenant_is_wildcard or other.tenant_is_wildcard
        )
        bots_overlap = self.bot_id == other.bot_id or self.bot_is_wildcard or other.bot_is_wildcard
    ...
    def semantically_equal(self, other: "Binding") -> bool:
        ...
        return self.policy_version == other.policy_version and (self.model or "") == (
            other.model or ""
        )
