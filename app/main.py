...
class _SSEShield:
    ...
    Strategy:
      ...
      4) Background/non-owner tasks immediately receive 'http.disconnect'.
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        # 2) Prepare patched receive.
        owner_task = asyncio.current_task()
        owner_sent = False

        async def patched_receive() -> Message:
            # Owner gets the body exactly once; everyone else immediately "disconnects".
            nonlocal owner_sent
