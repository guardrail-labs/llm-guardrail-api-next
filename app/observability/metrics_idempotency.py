"""Prometheus counters/histograms for idempotency layer."""
...
IDEMP_IN_PROGRESS = Gauge(
    "guardrail_idemp_in_progress_gauge", "Keys currently executing", ["tenant"]
)
IDEMP_EVICTIONS = Counter(
    "guardrail_idemp_evictions_total", "Store evictions/purges", ["tenant", "reason"]
)
