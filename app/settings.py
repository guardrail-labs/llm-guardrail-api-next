...
SANITIZER_ENABLED: bool = _env_bool("SANITIZER_ENABLED", True)
GUARD_INGRESS_ENABLED: bool = _env_bool("GUARD_INGRESS_ENABLED", True)
GUARD_EGRESS_ENABLED: bool = _env_bool("GUARD_EGRESS_ENABLED", True)
INGRESS_GUARD_TIMEOUT_MS: int = int(os.getenv("INGRESS_GUARD_TIMEOUT_MS", "150") or "150")
EGRESS_GUARD_TIMEOUT_MS: int = int(os.getenv("EGRESS_GUARD_TIMEOUT_MS", "200") or "200")
